          ...
          <Accordion type="single" collapsible className="space-y-2">
            {[
              ...
              },
              {
                ...
                a: "No prescription is needed. Your licensed medical professional will do a brief health assessment before your treatment to ensure the selected IV is appropriate for you.",
              },
              {
